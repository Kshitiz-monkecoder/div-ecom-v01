      ...
      <aside className="hidden lg:block w-[280px] xl:w-[300px] shrink-0 px-4 py-6 space-y-4">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-4">
          ...
          <div className="space-y-2">
            {[
  { icon: "💬", bg: "bg-green-100", label: "Chat on WhatsApp", sub: "Quick response", href: "https://wa.me/911234567890" },
  { icon: "📞", bg: "bg-blue-100", label: "Call Support", sub: "+91 12345 67890", href: "tel:+911234567890" },
  { icon: "🎫", bg: "bg-purple-100", label: "Create a Ticket", sub: "Get help via ticket", href: "/tickets/new" },
  { icon: "💬", bg: "bg-orange-100", label: "Live Chat", sub: "Chat with our team", href: "/tickets/new" },
].map((item) => (
  <a
    key={item.label}
    href={item.href}
