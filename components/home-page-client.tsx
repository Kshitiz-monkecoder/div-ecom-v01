...
export function HomePageClient({ userName, referralCode, orders }: Props) {
  ...
  return (
    // This div sits inside CustomerLayout's flex-1 div — same structure as before, minus the outer shell
  ...
  {t("home.greetingSuffix", { name: firstName })}
            ...
            {/* Video Player */}
            <div className="w-full sm:w-96 lg:w-120 shrink-0">
              <div className="relative rounded-2xl overflow-hidden bg-black shadow-2xl aspect-video">
                ...
                >
                  <source
                    src="https://res.cloudinary.com/dmk66g4w2/video/upload/v1770089560/Ashish_Jain___Solar_Monitor___Kavinagar___DIVY_POWER_Pvt_Ltd___TATA_Power_Pvt_Ltd_oxmonq.mp4"
                    type="video/mp4"
                  />
                </video>
              </div>
      ...
      {/* ─── Right Sidebar ─── */}
      <aside className="hidden lg:block w-72 xl:w-80 shrink-0 px-4 py-5 space-y-4">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-4">
          ...
          <div className="space-y-3">
            <a href="tel:+911234567890" className="flex items-center gap-3 text-sm text-gray-700 hover:text-orange-600 transition-colors">
